...
class AdapterRecyclerMovieFav(private val listMovie: ArrayList<ParcelableData>) : RecyclerView.Adapter<AdapterRecyclerMovieFav.CardViewHolder>() {
    ...
    inner class CardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(movie: ParcelableData) {
            ...
            itemView.setOnClickListener {
                ...
                objIntent.putExtra("mode","moviefav")
